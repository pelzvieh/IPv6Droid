...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (myPreferences.getString("tic_username", "").isEmpty() ||
            ...
            // this way, it doesn't work ("network on main thread") - also it could cause TIC hammering of a different kind
            /*
            // Read the tunnel specification from Tic
            TicConfiguration ticConfig = new TicConfiguration(
                    myPreferences.getString("tic_username", ""),
            ...
            try {
                ...
                List<TicTunnel> tunnelSpecs = getSuitables(tunnelIds, tic);
                statusReceiver.setAvailableTunnels(tunnelSpecs);
            } catch (Exception e) {
                Log.e(TAG, "Cannot read list of suitable tunnels", e);
            } finally {
                tic.close();
            }
            */
        }
        TicTunnel preferredTunnel = getTicTunnelFromPrefs();
        statusReceiver.setTunnel(preferredTunnel);
    ...
    protected void onPause() {
        ...
        if (tunnel != null) {
            ...
            putTicTunnelToPrefs(statusReceiver.isTunnelProven() ?
                    tunnel // this tunnel works, therefore is persisted to the settings
                    : null // this tunnel doesn't work, therefore the current setting is deleted.
            );
        }
    }
    ...
    private TicTunnel getTicTunnelFromPrefs() {
        ...
        String tunnelString = myLocalPrefs.getString(PREFS_LAST_TUNNEL, null);
        TicTunnel tunnel = statusReceiver.getTunnel();
    ...
    private void putTicTunnelToPrefs(TicTunnel tunnel) {
        ...
        try {
            ...
            myPrefs.edit().putString(PREFS_LAST_TUNNEL, String.format("%d", serialized)).commit();
        } catch (IOException e) {
    ...
    private class StatusReceiver extends BroadcastReceiver {
        ...
        private void saveState(Bundle state) {
            ...
            if (lastWorkingTunnel != null)
                state.putSerializable(VpnThread.EDATA_ACTIVE_TUNNEL, lastWorkingTunnel);
        }
        ...
        private void updateUi () {
            ...
            if (status == null || status == VpnThread.Status.Idle) {
            ...
            if (availableTunnels != null) {
                ...
                TicTunnel[] tunnelArray = availableTunnels.toArray(new TicTunnel[0]);
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            setTunnel((TicTunnel) intent.getSerializableExtra(VpnThread.EDATA_ACTIVE_TUNNEL));
